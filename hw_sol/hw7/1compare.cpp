...
int main()
{
    ...
    cout << "maxheap push T(ms)\tmaxheap pop T(ms)\tmyheap push T(ms)\tmyheap pop T(ms)\tmaxheap Time(ms)\tmyheap Time(ms)\n";
    ...
    for (int size : testSizes) {
        ...
        // 输出结果
        cout << scientific << setprecision(1) << fixed << duration_maxheap_insert << "\t\t\t" << duration_maxheap_remove << "\t\t\t" << duration_mymaxheap_insert << "\t\t\t" << duration_mymaxheap_remove << "\t\t\t"
