...
public:
    mymaxheap(int heapmaxlen, const T& maxelem, const T& minelem);
    ~mymaxheap();
    T top();
...
template <class T>
mymaxheap<T>::mymaxheap(int heapmaxlen, const T& maxelem, const T& minelem)
{
...
template <class T>
void mymaxheap<T>::push(const T& data)
{
...
template <class T>
void mymaxheap<T>::changelenth1D(int prevheapmaxlen, int nowheapmaxlen)
{
...
template <class T>
bool mymaxheap<T>::empty()
{
    return heapsize == 0;
}

template <class T>
void mymaxheap<T>::levelorder()
{
    int level = 2;
